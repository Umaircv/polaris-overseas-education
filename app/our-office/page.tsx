...
export const metadata: Metadata = {
  ...
  description: "Contact Polaris Overseas Education at 228C PIA Main Boulevard, Lahore. Get phone, email, WhatsApp, map and directions.",
};
...
export default function OurOfficePage() {
  const localBusinessData = {
    ...
    telephone: ["+92 341 6934362", "+92 300 0756932"],
    address: {
      "@type": "PostalAddress",
    ...
    <InnerPage>
      ...
      <section className="inner-content-section office-contact-section">
        ...
        <div className="office-contact-grid">
          <a href="tel:+923416934362"><span>CALL 01</span><strong>+92 341 6934362</strong><small>Tap to call the counselling team</small><i aria-hidden="true">↗</i></a>
          <a href="tel:+923000756932"><span>CALL 02</span><strong>+92 300 0756932</strong><small>Alternative contact number</small><i aria-hidden="true">↗</i></a>
      ...
      <section className="office-map-section">
        ...
        <div className="map-frame">
          <iframe src={embedUrl} title="Polaris Overseas Education office map" loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
        </div>
      </section>
